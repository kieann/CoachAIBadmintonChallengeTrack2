...
output_file = open("./eval_loss", "w")
output_file.write("total_loss, location_MSE_loss, location MAE_loss, type_loss\n")
output_file.write("{:.4f},{:.4f},{:.4f},{:.4f}".format(test_loss, test_loss_MSE_location, test_loss_MAE_location, test_loss_type))
